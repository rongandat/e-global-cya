<?php /* Smarty version 2.6.18, created on 2013-08-01 05:52:21
...
" method="post" >
    ...
    <table cellpadding="2" cellspacing="2" border="0" width="100%" height="98" >
        <tr >
            <td width="100">&nbsp;</td>
            <td align="left"  class="contenButtons" valign="top"> 
                <font face="Tahoma"> 
                <input  name="confirm_message" id="confirm_message" type="checkbox"    value="1"  onchange="checkConfirm();" /></font>
        ...
        <tr>
             <td>&nbsp;</td>
            <td align="left"  class="contenButtons" valign="top"> 
                <font size="2" face="Tahoma">Please check your email to get verification code&nbsp;</font>
